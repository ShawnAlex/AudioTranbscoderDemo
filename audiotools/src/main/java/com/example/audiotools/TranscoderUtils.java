...
public class TranscoderUtils {
    ...
    public static TranscoderUtils newInstance() {
        return new TranscoderUtils();
    }
...
//                    format.setInteger(MediaFormat.KEY_MAX_INPUT_SIZE, 200 * 1024);
    ...
    public void startAsync() {
        ...
        new Thread(new TranscoderUtils.DecodeRunnable()).start();
        new Thread(new TranscoderUtils.EncodeRunnable()).start();
...
// fill in ADTS data
    ...
    private class DecodeRunnable implements Runnable {
        ...
        public void run() {
            try {
                ...
                Log.e(TAG, "=DecodeRunnable=" + e.getMessage());
            }
    ...
    private class EncodeRunnable implements Runnable {
        ...
        public void run() {
            try {
                ...
                Log.e(TAG, "=EncodeRunnable=" + e.getMessage());
            }
        }
    }
    ...
    public void setOnProgressListener(AudioCodec.OnProgressListener onProgressListener) {
